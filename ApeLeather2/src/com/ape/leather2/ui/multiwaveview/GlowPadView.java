...
import android.widget.Toast; // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->

//import com.android.incallui.InCallActivity; // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
import com.ape.leather2.R;

import java.util.ArrayList;

import android.graphics.RectF; // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
/**
...
public class GlowPadView extends View {
    ...
    private Context mContext; // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
    ...
    private static final int CHEVRON_INCREMENTAL_DELAY = 320/*160*/;
    ...
    public GlowPadView(Context context) {
        this(context, null);
        mContext = context; // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
    }
    ...
    public GlowPadView(Context context, AttributeSet attrs) {
        ...
        // <!-- BEGIN TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
        if (a.getValue(R.styleable.GlowPadView_chevronDrawables, outValue)) {
    ...
    private void startChevronAnimation() {
        final float chevronStartDistance = mHandleDrawable.getWidth() * 0.8f /*-200*/ + 50;
...
//        Log.d("wmj","chevronStartDistance:"+chevronStartDistance);
//        Log.d("wmj","chevronStopDistance:"+chevronStopDistance);
...
//            Log.d("wmj","direction:"+direction);
//            Log.d("wmj","sx:"+sx);
//            Log.d("wmj","sy:"+sy);
//            Log.d("wmj","xrange[0]:"+xrange[0]+" xrange[1]:"+xrange[1]);
//            Log.d("wmj","yrange[0]:"+yrange[0]+" yrange[1]:"+yrange[1]);
    ...
    private void switchToState(int state, float x, float y) {
        switch (state) {
            case STATE_IDLE:
                deactivateTargets();
//                hideGlow(0, 0, 0.0f, null); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            ...
            case STATE_START:
                deactivateHandle(0, 0, 1.0f, null); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
                startBackgroundAnimation(0, 0.0f);
                break;

            case STATE_FIRST_TOUCH:
//                mHandleDrawable.setAlpha(0.0f); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
                deactivateTargets();
                showTargets(true);
            ...
            case STATE_TRACKING:
//                mHandleDrawable.setAlpha(0.0f); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
//                showGlow(REVEAL_GLOW_DURATION , REVEAL_GLOW_DELAY, 1.0f, null); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
                break;
...
//            hideGlow(RETURN_TO_HOME_DURATION, RETURN_TO_HOME_DELAY, 0.0f, mResetListener); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            deactivateHandle(RETURN_TO_HOME_DURATION, RETURN_TO_HOME_DELAY, 0.0f, mResetListener); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
...
//            hideGlow(HIDE_ANIMATION_DURATION, 0, 0.0f, mResetListenerWithPing); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            deactivateHandle(HIDE_ANIMATION_DURATION, HIDE_ANIMATION_DELAY, 1.0f, mResetListenerWithPing); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
    ...
    private void internalSetTargetResources(int resourceId) {
        ...
        if (mMaxTargetWidth != maxWidth || mMaxTargetHeight != maxHeight) {
            ...
            updateChevronPositions(mWaveCenterX, mWaveCenterY); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
        }
    }
    /**
    ...
    public void resetChevronResources(int resourceId) {
        mChevronDrawables.clear();
        ArrayList<TargetDrawable> chevrons = loadDrawableArray(resourceId);
        for (int i = 0; i < chevrons.size(); i++) {
            final TargetDrawable chevron = chevrons.get(i);
            for (int k = 0; k < mFeedbackCount; k++) {
                mChevronDrawables.add(chevron == null ? null : new TargetDrawable(chevron));
...
//            }
            ...
            // TODO
//            if (InCallActivity.getLeatherStatic())
//                stopAndHideWaveAnimation();
    ...
    public void reset(boolean animate) {
        ...
        startBackgroundAnimation(0, 0.0f);
//        stopAndHideWaveAnimation();
        hideChevrons(); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
...
//        hideGlow(0, 0, 0.0f, null); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
    ...
    private void handleMove(MotionEvent event) {
        ...
        if (activeTarget != -1) {
            ...
            moveHandleTo(x, y, false); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
//            updateGlowPosition(x, y); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
        } else {
            switchToState(STATE_TRACKING, x, y);
            moveHandleTo(x, y, false); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
//            updateGlowPosition(x, y); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
        }
         invalidateGlobalRegion(mHandleDrawable); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
        if (mActiveTarget != activeTarget) {
            ...
            if (activeTarget != -1) {
                ...
                activateHandle(0, 0, 0.0f, null); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            }
            // <!-- BEGIN TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            else {
...
//            updateGlowPosition(tx, ty); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            moveHandleTo(tx, ty, false); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
            mDragging = true;
            return true;
        }
        return false;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.w(TAG, "TOP   = " +top);
        if(top > 0) {
            newWaveCenterY = newWaveCenterY - 140;
        }

        Log.d("zfh", "mTargetDrawables.size() = " + mTargetDrawables.size());
        final int ntargets = mTargetDrawables.size();
        mOneTargets = 0;
        for (int i = 0; i < ntargets; i++) {
            TargetDrawable target = mTargetDrawables.get(i);
            if (target != null) {
                Log.d("zfh", "target.getResourceId() = " + target.getResourceId());
                if(target.getResourceId() != 0){
                    mOneTargets ++ ;
                }
            }
        }
        
        Log.d("zfh", "mOneTargets = "+mOneTargets);
        if(mOneTargets == 1){
            newWaveCenterX = newWaveCenterX + 260;
        }
        // <!-- END TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
        if (mInitialLayout) {
            // <!-- BEGIN TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
...
//            stopAndHideWaveAnimation();
        ...
        updateChevronPositions(newWaveCenterX, newWaveCenterY); // <!-- Line TINNO_SUBDISPLAYINFO_APP, SUB CALL SCREEN -->
