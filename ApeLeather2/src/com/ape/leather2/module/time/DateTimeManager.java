package com.ape.leather2.module.time;
...
public class DateTimeManager {
    ...
    public void open() {
        ...
        Logger.i(TAG, "[open]register DataTimeReceiver");
    }
    ...
    public void close() {
        if (mDateTimeReceiver != null) {
            ...
            Logger.i(TAG, "[close]unregister DataTimeReceiver");
        }
    }
    ...
    private class DateTimeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Logger.i(TAG, "[DateTimeReceiver]action:%s", intent.getAction());
            if (mCallback != null) {
